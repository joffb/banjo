...
if len(sys.argv) < 3:
	print("Usage:")
	print("\tpython furnace2json.py infile.fur outfile.json")
	sys.exit()
...
try:
	...
	print("Error reading input file: " + sys.argv[1])
	sys.exit()

# read .fur into data array
data = infile.read()
infile.close()
...
if data[0:16].decode("utf-8") != MAGIC_STRING:
    print("file is not a valid furnace .fur")
    sys.exit()
