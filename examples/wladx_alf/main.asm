...
.define CHAN_COUNT CHAN_COUNT_SN + CHAN_COUNT_SN + CHAN_COUNT_SN + CHAN_COUNT_SN
...
init:
	...
	ld a, CHAN_COUNT_SN + CHAN_COUNT_SN + CHAN_COUNT_SN + CHAN_COUNT_SN
	ld l, BANJO_HAS_SN | BANJO_HAS_DUAL_SN
	call banjo_init
