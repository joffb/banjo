...
python ..\..\json2sms.py -o cmajor.asm -i cmajor --sdas -b 2 -a BANK2 -b 2 .\cmajor.json 
...
python ..\..\json2sms.py -o cmajor_sn.asm -i cmajor_sn --sdas -b 3 -a BANK3 -b 3 .\cmajor_sn.json
...
python ..\..\json2sms.py -o sfx_test.asm -s 2 -i sfx_test --sdas -b 2 -a BANK2 -b 2 .\sfx_test.json
...
python ..\..\json2sms.py -o sfx_test_sn.asm -s 1 -i sfx_test_sn --sdas -b 3 -a BANK3 -b 3 .\sfx_test_sn.json
