...
sdcc -c -I../../music_driver_sdas -mz80 --codeseg BANK2 bank2.c
sdcc -o visualiser.ihx -mz80 --no-std-crt0 --data-loc 0xC000 \
    ...
    ../../lib/banjo_sfx.rel \
    ../../lib/banjo_queue.rel \
    main.rel bank1.rel bank2.rel sfx_test.rel sfx_test_sn.rel cmajor.rel cmajor_sn.rel
