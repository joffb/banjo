...
python3 ../../json2sms.py -o cmajor.asm -i cmajor --sdas -a BANK ./cmajor.json 
...
python3 ../../json2sms.py -o cmajor_sn.asm -i cmajor_sn --sdas -a BANK ./cmajor_sn.json
...
python3 ../../json2sms.py -o sfx_test.asm -s 2 -i sfx_test --sdas -a BANK ./sfx_test.json
...
python3 ../../json2sms.py -o sfx_test_sn.asm -s 2 -i sfx_test_sn --sdas -a BANK ./sfx_test_sn.json
